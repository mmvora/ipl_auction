(function () {
  ...
  style.textContent = `
    ...
    :root {
      ...
      --space-5: 24px;
      --radius: 12px;
      --shadow-soft: 0 10px 30px rgba(5, 12, 26, 0.25);
    }
    ...
    * { font-family: 'Inter', system-ui, sans-serif; box-sizing: border-box; }
    ...
    body {
      ...
      min-height: 100vh;
      margin: 0;
      background-image: radial-gradient(ellipse 110% 45% at 50% 0%, #0e2448 0%, var(--bg) 65%);
    }

    .top-line {
      height: 3px;
      background: linear-gradient(90deg, transparent 0%, #8a6a00 8%, var(--gold) 30%, #fff3a8 50%, var(--gold) 70%, #8a6a00 92%, transparent 100%);
    }

    .header-bar { background: rgba(7, 13, 30, 0.97); border-bottom: 1px solid var(--border); backdrop-filter: blur(8px); }
    .header-shell { max-width: 1024px; margin: 0 auto; padding: 0 var(--space-5); }

    .logo-img, .logo-fallback {
      width: 48px; height: 48px; border-radius: 50%; flex-shrink: 0;
      box-shadow: 0 0 10px rgba(247, 193, 30, 0.35);
    }
    .logo-img { object-fit: cover; border: 2px solid var(--gold); }
    .logo-fallback {
      background: linear-gradient(135deg, #c49a00, var(--gold)); color: #07111e;
      font-size: 14px; font-weight: 900; display: flex; align-items: center; justify-content: center;
    }

    .nav-row { display: flex; gap: 22px; overflow-x: auto; padding-bottom: 2px; }
    .nav-link {
      color: var(--muted); font-size: 0.875rem; font-weight: 500; padding: 0 2px 14px; position: relative;
    ...
    .cd-seg {
      background: var(--muted-bg); border: 1px solid var(--border); border-radius: 6px; padding: 4px 9px;
    ...
    @media (max-width: 720px) {
      .header-shell { padding: 0 var(--space-4); }
      .header-top { flex-direction: column; align-items: flex-start; gap: var(--space-3); padding: 14px 0; }
      .logo-title { font-size: 0.9rem !important; }
      #countdown { align-items: flex-start !important; width: 100%; }
      .countdown-meta { flex-wrap: wrap; gap: var(--space-2) !important; }
      .nav-row { gap: 16px; }
      .nav-link { font-size: 0.82rem; padding-bottom: 12px; }
    }
  `;
    ...
    const headerHTML = `
      ...
      <header class="header-bar">
        <div class="header-shell">
          <div class="header-top" style="display:flex;align-items:center;justify-content:space-between;padding:14px 0;gap:16px;">
            <div style="display:flex;align-items:center;gap:12px;">
              ...
              <div>
                <div class="logo-title" style="font-weight:800;font-size:0.95rem;color:var(--fg);line-height:1.2;letter-spacing:0.01em;">IPL Fantasy League</div>
            ...
            <div id="countdown" style="display:flex;flex-direction:column;align-items:flex-end;gap:2px;">
              ...
              <div class="countdown-meta" style="display:flex;align-items:center;gap:10px;">
